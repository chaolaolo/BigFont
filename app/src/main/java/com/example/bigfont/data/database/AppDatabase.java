...
//                tipDao.deleteAll();
//                tipDao.insert(new Tip("Tip 1", "Điều chỉnh kích thước font chữ trên điện thoại của bạn có thể giúp bạn dễ dàng đọc hơn."));
//                tipDao.insert(new Tip("Tip 2", "Sử dụng chế độ tương phản cao để làm nổi bật văn bản trên nền tối."));
//                tipDao.insert(new Tip("Tip 3", "Cân nhắc sử dụng chế độ đọc để loại bỏ các yếu tố gây xao lãng khi đọc."));
//                tipDao.insert(new Tip("Tip 4", "Một số ứng dụng cho phép bạn thay đổi cỡ chữ riêng biệt."));
//                tipDao.insert(new Tip("Tip 5", "Tăng độ sáng màn hình để đọc dễ hơn trong điều kiện ánh sáng yếu."));
//            });
        }
    };
